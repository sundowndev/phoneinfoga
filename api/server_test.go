	...
	t.Run("Serve", func(t *testing.T) {
		...
		t.Run("localScan - /api/numbers/:number/scan/local", func(t *testing.T) {
			t.Run("valid number", func(t *testing.T) {
				...
				assert.Equal(t, err, nil)
				assert.Equal(t, res.Result().StatusCode, 200)
				assert.Equal(t, string(body), `{"success":true,"result":{"rawLocal":"12345253","local":"12345253","E164":"+3312345253","international":"3312345253","countryCode":33,"country":"FR","carrier":""}}`)
			})

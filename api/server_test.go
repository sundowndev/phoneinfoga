...
func TestApi(t *testing.T) {
	...
	t.Run("Serve", func(t *testing.T) {
		t.Run("detectContentType", func(t *testing.T) {
			...
			assert.Equal("text/javascript; charset=utf-8", contentType, "should be equal")
		...
		t.Run("getAllNumbers - /api/numbers", func(t *testing.T) {
			...
			assert.Equal(res.Result().StatusCode, 200, "should be equal")
			assert.Equal(string(body), "{\"success\":true,\"numbers\":[]}", "should be equal")
		})
		...
		t.Run("validate - /api/numbers/:number/validate", func(t *testing.T) {
			t.Run("valid number", func(t *testing.T) {
				...
				assert.Equal(err, nil, "should be equal")
				assert.Equal(res.Result().StatusCode, 200, "should be equal")
				assert.Equal(string(body), "{\"success\":true,\"message\":\"The number is valid\"}", "should be equal")
			})
			...
			t.Run("invalid number", func(t *testing.T) {
				...
				assert.Equal(`{"success":false,"error":"the given phone number is not valid"}`, string(body))
			})
		...
		t.Run("localScan - /api/numbers/:number/scan/local", func(t *testing.T) {
			t.Run("valid number", func(t *testing.T) {
				...
				assert.Equal(err, nil, "should be equal")
				assert.Equal(res.Result().StatusCode, 200, "should be equal")
				assert.Equal(string(body), `{"success":true,"result":{"rawLocal":"12345253","local":"12345253","E164":"+3312345253","international":"3312345253","countryCode":33,"country":"FR","carrier":""}}`, "should be equal")
			})
		...
		t.Run("ovhScan - /api/numbers/:number/scan/ovh", func(t *testing.T) {
			t.Run("should find number on OVH", func(t *testing.T) {
				...
				assert.Equal(err, nil, "should be equal")
				assert.Equal(res.Result().StatusCode, 200, "should be equal")
				assert.Equal(string(body), `{"success":true,"result":{"found":true,"numberRange":"036517xxxx","city":"Abbeville","zipCode":""}}`, "should be equal")
		...
		t.Run("healthHandler - /api/", func(t *testing.T) {
			...
			assert.Equal("{\"success\":true,\"version\":\"dev\",\"commit\":\"dev\"}", string(body), "should be equal")
		})
